...
if __name__ == '__main__':
    ...
    #
    # # test
    block = int('1122334455667700ffeeddccbbaa9988', 16)
    key = int('8899aabbccddeeff0011223344556677fedcba98765432100123456789abcdef', 16)
    block_encr = kuznyechik_encrypt(block, key)
    print(block_encr)
    decrypted_block = kuznyechik_decrypt(block_encr, key)
